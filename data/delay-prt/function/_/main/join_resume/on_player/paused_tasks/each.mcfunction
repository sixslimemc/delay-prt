...
# resume task:
data modify storage delay:in delay.uuids set value [{uuid:[0, 0, 0, 0]}]
data modify storage delay:in delay.uuids[0] set from storage delay-prt:_ t.join.uuid
