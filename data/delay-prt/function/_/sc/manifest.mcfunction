#> delay-prt:_/sc/manifest
# @ MANIFEST

data remove storage slimecore:in manifest.pack

data modify storage slimecore:in manifest.pack.pack_id set value "delay-prt"
...
data modify storage slimecore:in manifest.pack.url set value "https://github.com/sixslimemc/delay-prt/releases/download/v0.1.0/sixslime.delay-prt.0.1.0.zip"

data modify storage slimecore:in manifest.pack.display.name set value "Delay - Player Relative Time"
data modify storage slimecore:in manifest.pack.display.summary set value "Pause tasks for player-targets while they are offline."
...
data modify storage slimecore:in manifest.pack.display.links.info set value "https://github.com/sixslimemc/delay-prt"
...
data modify storage slimecore:in manifest.pack.dependencies append value {pack_id:"delay", author_id:"sixslime", optional:false, version:{major:0, minor:1}, download:{url:"https://github.com/sixslimemc/delay/releases/download/v0.1.0/sixslime.delay.0.1.0.zip", version:{major:0, minor:1, patch:0}}}
...
data modify storage slimecore:in manifest.pack.dependencies append value {pack_id:"pdata", author_id:"sixslime", optional:false, version:{major:0, minor:1}, download:{url:"https://github.com/sixslimemc/pdata/releases/download/v0.1.0/sixslime.pdata.0.1.0.zip", version:{major:0, minor:1, patch:0}}}
