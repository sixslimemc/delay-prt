...
data modify storage slimecore:in manifest.pack set value "delay-prt"
data modify storage slimecore:in manifest.version set value {major:1, minor:0, patch:0}
data modify storage slimecore:in manifest.display.name set value "Delay - Player Relative Time"
...
data modify storage slimecore:in manifest.dependencies append value {pack:"delay", url:"TODO", version:{major:1, minor:0}}
...
data modify storage slimecore:in manifest.dependencies append value {pack:"pdata", url:"TODO", version:{major:1, minor:0}}
